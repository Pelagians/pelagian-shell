...
Each engine runs fresh sessions at 1920×1080 and 1366×768. In-session output resizing, viewer disconnect/reconnect, and downstream Grotto/Cage qualification remain follow-up work. The restart test kills layoutd and waits for the session supervisor to replace it, without launching a daemon from the test.
